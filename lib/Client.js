...
module.exports = class LoidBotCommandoClient extends CommandoClient {
  constructor (options) {
     ...
     */
    this.sequelize = new Sequelize(BOT_DATABASE_DSN, { logging: this.logger.verbose.bind(this.logger) })
    this.guildMemberReductions = require('../models/guildMemberReductions.js')(this.sequelize, Sequelize.DataTypes)
    this.guildMemberState = require('../models/guildMemberState.js')(this.sequelize, Sequelize.DataTypes)
    this.sequelize.sync()
  }
}
